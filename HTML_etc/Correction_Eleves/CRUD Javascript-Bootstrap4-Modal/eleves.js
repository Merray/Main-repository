...
function initTable() {
	...
	for (var i = 0; i < eleves.length; i++) {
		...
		buttonsCell.innerHTML = "<div class='btn-group'><button type='button' data-toggle='modal' data-target='#formModal'  class='btn btn-info btn-sm' onclick='editEleve("+eleve.id+")'><span class='fas fa-edit'></span></button><button type='button' class='btn btn-danger btn-sm' onclick='deleteEleve("
				+ eleve.id
